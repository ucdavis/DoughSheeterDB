...
thread_r = Thread(target=phidgets.runMotorsLoop, args=(-1,25,))
thread_r.start()
...
thread_c = Thread(target=phidgets.runConveyors, args=(2,30,1,20))
thread_c.start()
...
thread_r = Thread(target=phidgets.runMotorsLoop, args=(1,55,))
thread_r.start()
...
# Arguments are Belt 0, Belt 1
thread_c = Thread(target=phidgets.runConveyors, args=(1,50,2,60))
thread_c.start()
...
print "Start the rollers"
phidgets.set_rsFileName(expPath + "rollers_1.txt")
thread_r = Thread(target=phidgets.runMotorsLoop, args=(-1,105,))
thread_r.start()
...
print "Start the conveyors"
phidgets.set_csFileName(expPath + "conveyor_1.txt")
thread_c = Thread(target=phidgets.runConveyors, args=(2,110,1,100))
thread_c.start()
...
print "Start the rollers"
phidgets.set_rsFileName(expPath + "rollers_1.txt")
thread_r = Thread(target=phidgets.runMotorsLoop, args=(1,205,))
thread_r.start()
...
print "Start the conveyors"
phidgets.set_csFileName(expPath + "conveyor_1.txt")
thread_c = Thread(target=phidgets.runConveyors, args=(1,200,2,210))
thread_c.start()
