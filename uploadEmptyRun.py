...
#This code is for uploading empty run data from local computer to google sheet. 
# The experiment workbook does not contain analysis sheet, visualization sheet, or consolidated sheet. 
...
#open raw height data sheet in webbrowser
shID = sh.id
webbrowser.open('https://docs.google.com/spreadsheets/d/'+shID +'/edit#gid='+str(rawData.id)) )
