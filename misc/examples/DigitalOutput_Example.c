...
main(int argc, char **argv) {
	...
	*/
	...
	res = PhidgetDigitalOutput_create(&ch);
	if (res != EPHIDGET_OK) {
	...
	*/
	...
	printf("Setting State to 1 for 5 seconds...\n");
	PhidgetDigitalOutput_setState(ch, 1);
	ssleep(5);

	printf("Setting State to 0 for 5 seconds...\n");
	PhidgetDigitalOutput_setState(ch, 0);
	ssleep(5);
